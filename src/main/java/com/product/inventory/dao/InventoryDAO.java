...
public class InventoryDAO
{
    ...
    static 
    {
        ...
        try {
            ...
            inventoryList.getinventoryList().add(new Inventory(1,"Prod1", "Shirt", "EACH",new Double("20.0"),format.parse("2022-08-18")));
            inventoryList.getinventoryList().add(new Inventory(1,"Prod1", "Shirt", "EACH",new Double("20.0"),format.parse("2022-08-25")));
